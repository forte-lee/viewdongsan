...
import { GuestAlarmSection, GuestAreaSection, GuestElevatorSection, GuestEnterDateSection, GuestFloorSection, 
    GuestInfoSection, GuestLocationSection, GuestMemoSection, GuestParkingSection, GuestPersonSection, GuestPetSection, GuestPhoneSection, 
    ...
    return (
        <div className="w-full max-w-[800px] min-w-[800px] justify-start items-start">
            ...
            <GuestPropertyRegisterBody>
                ...
                <GuestRoomSection
                    roomCheck={state.room_check}
                    roomNumber={state.room_number}
                    roomBathRoomNumber={state.room_bathroom_number}
                    roomIsLivingRoom={state.room_is_livingroom}
                    onRoomCheckChange={(value) => setField("room_check", value)}
                    onNumberChange={(value) => setField("room_number", value)}
                    onBathRoomNumberChange={(value) => setField("room_bathroom_number", value)}
                    onIsLivingRoomChange={(value) => setField("room_is_livingroom", value)}
                />
                ...
                <GuestPetSection
                    petCheck={state.pet_check}
                    petIsPet={state.pet_is_pet}
                    petMemo={state.pet_memo}
                    onPetCheckChange={(value) => setField("pet_check", value)}
                    onPetIsPetChange={(value) => setField("pet_is_pet", value)}
                    onPetMemoChange={(value) => setField("pet_memo", value)}
                />
