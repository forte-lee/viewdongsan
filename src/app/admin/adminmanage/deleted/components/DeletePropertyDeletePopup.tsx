...
interface DeletePropertyDeletePopupProps {
    children: React.ReactNode;
    propertyId: number;
    onDelete: () => void;
}

function DeletePropertyDeletePopup({ children, propertyId, onDelete }: DeletePropertyDeletePopupProps) {
...
export { DeletePropertyDeletePopup };
