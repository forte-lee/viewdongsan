 ...
 * @returns 평균 기타점수, 계산 불가능한 경우 undefined
 */
export function calculateAverageOtherScore(
    ...
    const filteredProperties = allProperties.filter((property) => {
        ...
        // 4. 기타점수 계산 가능한 매물 (calculateOtherScore가 undefined가 아니고 0이 아닌 것)
